...
#first_name{width:387px;}
#home_phone{width:387px;}
#email{width:387px;}
#birth_date{width:387px;}
#preferred_university{width:187px;}
#IELTS{width:245px;}
#passport_no{width:387px;}
#session{width:387px;}
#Subject{width:387px;}
#experiences{width:167px;}
.errorind{ color:red;}
#address1{ width:387px;}
        ...
        <script type="text/javascript">
           ...
           jQuery(function(){
				...
				jQuery("#home_phone").validate({
                    expression: "if (VAL.match(/[0-9-()+]{8,12}/)) return true; else return false;",
...
<div style="width:980px; min-height:450px; margin:10px 10px 10px 10px; background-color: #CCC;"><!--Page Area -->
...
<div  style=" width:980px; min-height:800px; text-align:left; line-height:25px; background:#CEE7FF;">
        <div>
        	<div style="background:#005288; height:32px;"><h2 style="color:#FC0; margin:0 0 0 20px; text-align:center;">Employee Resume Form</h2></div>
        ...
        <ul class="form-list" style="list-style:none;">
                    <li>
                        <div>
                            ...
                            <div id="second-side-style01">
                                <input name="first_name" id="first_name" value="" type="text">
                            </div>
                    ...
                    <li>
                        <div>
                            ...
                            <div id="second-side-style01">
                                <input name="father_name" id="father_name" value="" type="text">
                            </div>
                            <div style="clear:both;"></div>
                        </div>
                    </li>
                    ...
                    <li>
                        <div>
                            ...
                            <div id="second-side-style01">
                                <input name="mother_name" id="mother_name" value="" type="text">
                            </div>
                            <div style="clear:both;"></div>
                        </div>
                    </li>
					...
					<li>
                         	<div>
                                ...
                                <div id="second-side-style01">
                              		<input class="input-text valid" id="present_address" name="present_address" value="" type="text">
                                </div>
                                <div style="clear:both;"></div>
                            </div>
					</li>
					...
					<li>
                         	<div>
                                ...
                                <div id="second-side-style01">
                              		<input class="input-text valid" id="permanent_address" name="permanent_address" value="" type="text">
                                </div>
                                <div style="clear:both;"></div>
                            </div>
					</li>
					...
					<li>
                         	<div>
                                <div id="first-side-style01">
                                   Phone:<span class="errorind">*</span>
                                </div>
                                <div id="second-side-style01">
                              		<input novalidate="novalidate" name="home_phone" id="home_phone" class="elegroup input-small valid" type="text">
                                </div>
                                <div style="clear:both;"></div>
                            </div>
					</li>
					<li>
                         	<div>
                                ...
                                <div id="second-side-style01">
                              		<input name="email" id="email" value="" class="input-text email required valid" type="text">
                                </div>
                                <div style="clear:both;"></div>
                            </div>
					</li>
					...
					<li>
                         	<div>
                                ...
                                <div id="second-side-style01">
                              		 <input  name="date" id="birth_date" placeholder="yyyy-mm-dd" value="" type="date">
                                </div>
                                <div style="clear:both;"></div>
                            </div>
					</li>
                    <li>
                            <div>
                                ...
                                <div id="second-side-style01">
                                <input  name="nationality" id="nationality" value="Bangladeshi" type="text">
                                </div>
                                <div style="clear:both;"></div>
                            </div>
					</li>
                    <li>
                            <div>
                                ...
                                <div id="second-side-style01">
                                         <input  name="national_id_no" id="national_id_no" value="" type="text">	
                                </div>
                                <div style="clear:both;"></div>
                            </div>
					</li>
          ...
          <div style="width:960px; min-height:150px;">
            ...
            <table id="vatued">
               <tr>
                 ...
                 <th width="13%">% of marks/GPA</th>
                 <th width="26%">Board/University</th>
               ...
               <tr>
                 ...
                 <td><input name="gpa_ssc" id="gpa_ssc" value="" type="text"></td>
                 <td>
               ...
               <tr>
                 ...
                 <td><input name="gpa_hsc" id="gpa_hsc" value="" type="text"></td>
                 <td>
                 ...
                 <td>
                    <select name="noe_bsc" class="noe_bsc" id="noe_hsc">
                        ...
                        <optgroup label="Bachelor(Pass)">
                            <option value="11">BCom</option>
                            <option value="12">BSS</option>
                            <option value="13">BA</option>
                            <option value="14">BSc</option>
                            <option value="15">LLB</option>
              ...
              <select class="gs_bsc" id="gs_bsc" name="gs_bsc">
                ...
                <option value="187">Others Bachelors</option>
                 ...
                 <td><input name="gpa_bsc" id="gpa_bsc" value="" type="text"></td>
                 <td>
    ...
    <tr>
      <td colspan="4" class="rightmenu" align="center"><table style="border:0px;" border="0" width="100%">
        ...
        <tr>
          ...
          <td align="left">
            <input name="ETO_D1" class="text" id="ETO_D1" placeholder="yyyy-mm-dd"  type="date">           
           </td>
        </tr>
      </tbody></table></td>
    </tr>
