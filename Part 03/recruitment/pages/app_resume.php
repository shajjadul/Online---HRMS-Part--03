...
<div style="width:980px; min-height:450px; margin:-15px 10px 10px 10px; background-color: #CEE7FF;"><!--Page Area -->
 ...
 <img src="../../appimage/<?php echo $rows02[2];?>" height="150" width="150"  border="0"/>
 </div>
 ...
 <div style="min-height:200px; width:880px; margin:5px 0 0 100px;">
  ...
  <tr>
  <th id="sub_td">Date of Birth</th> <td>:</td> <td><?php echo $app_birth_day;?></td>
  </tr>
  <tr>
 ...
 <div style="background:#C68C8C; height:32px; margin-top:5px;"><h3 style="color:#00F; margin:0 0 0 20px;">SCHOLASTIC STATUS</h3></div>
        ...
        <table width="100%"><tbody>
          <tr>
           ...
           <td width="1%" valign="top">:</td>
           <td width="30%" valign="top"><?php echo $app_type_array[$rows05[3]];?></td>
          </tr>
        ...
        <form method="post" action="app_resume_edit_form.php">
        <input type="hidden" value="<?php echo $app_id;?>" name="app_id" />
         <a style="text-decoration:none;" href="confirm.php?app=<?php echo $app_id;?>"><input type="button" name="confirm" value="Confirm"></a>
